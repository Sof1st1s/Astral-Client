...
(Antivirus false flag refers to a false positive, where security software incorrectly identifies a legitimate file or program as malicious.  
This can disrupt workflows, block essential applications, or cause unnecessary panic, even though no real threat exists)
